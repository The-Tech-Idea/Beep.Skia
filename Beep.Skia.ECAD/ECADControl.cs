...
{
    public abstract class ECADControl : MaterialControl
    {
        ...
        protected override void DrawContent(SKCanvas canvas, DrawingContext context)
        {
            ...
            DrawECADContent(canvas, context);
        }

        protected virtual void DrawECADContent(SKCanvas canvas, DrawingContext context)
        {
