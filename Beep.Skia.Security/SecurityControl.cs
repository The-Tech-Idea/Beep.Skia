...
{
    public abstract class SecurityControl : MaterialControl
    {
        ...
        public int InPortCount { get => InConnectionPoints.Count; set { int v = Math.Max(0, value); if (InConnectionPoints.Count != v) { EnsurePortCounts(v, OutConnectionPoints.Count); SyncCounts(); InvalidateVisual(); } } }
        public int OutPortCount { get => OutConnectionPoints.Count; set { int v = Math.Max(0, value); if (OutConnectionPoints.Count != v) { EnsurePortCounts(InConnectionPoints.Count, v); SyncCounts(); InvalidateVisual(); } } }
        ...
        protected override void DrawContent(SKCanvas canvas, DrawingContext context)
        {
            ...
            DrawSecurityContent(canvas, context);
        }

        protected virtual void DrawSecurityContent(SKCanvas canvas, DrawingContext context)
        {
        ...
        protected virtual void LayoutPorts() => LayoutPortsVertical(6f, 6f);
